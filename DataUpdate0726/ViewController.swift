...
//  DataUpdate0726
//
//  Created by Woojin on 26/07/2019.
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        request.response{
            ...
            //Nuke의 이미지 처리 옵션 만들기
            let options = ImageLoadingOptions(placeholder: UIImage(named:"RedCoffeeCup.png"), transition:
                .fadeIn(duration: 2))
        ...
        */
        ...
        //이미지 파일의 경로와 업데이트 된 시간을 기록한 파일의 경로를 생성
